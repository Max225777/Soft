...
class NicheEditor(QDialog):
    ...
    def _build_ui(self) -> None:
        ...
        self.bumps_per_day.setRange(0, 10000)
        bump_form.addRow("Підйомів за добу від цієї ніші (0 = без обмеження):", self.bumps_per_day)
        ...
        self.stuck_bumps_per_day.setRange(0, 10000)
        stuck_form.addRow("Підйомів закріплених за добу (0 = без обмеження):", self.stuck_bumps_per_day)
        self.stuck_cooldown = QSpinBox()
        self.stuck_cooldown.setRange(0, 10000)
        self.stuck_cooldown.setSuffix(" хв")
