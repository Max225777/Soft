...
const SMM_TITLES: Record<string, string> = {
  ...
  tg_react_nails:      '💅 Реакції',
  tg_react_crazy:      '🤪 Реакції',
  tg_react_heartarrow: '💘 Реакції',
  tg_react_monkey:     '🙉 Реакції',
  tg_react_kiss:       '😘 Реакції',
  tg_react_sunglasses: '😎 Реакції',
  tg_react_alien:      '👾 Реакції',
  tg_react_shrug:      '🤷 Реакції',
  tg_react_angry:      '😡 Реакції',
  tg_react_neg_mix1:   '👎😁😢💩 Мікс',
  tg_react_mix_fun:    '🕊🦄🍓🎄 Мікс',
  tg_react_mix_ghost:  '🐳🍾👻🎃 Мікс',
  tg_react_neg_mix2:   '👎💩😱😢 Мікс',
  tg_react_mix_scare:  '😨🤯😱🤮 Мікс',
}
